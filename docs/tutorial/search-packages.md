...
You can search packages by [khulnasoft g](/docs/reference/usage#khulnasoft-generate) command.
...
If `-i` option is set, then the package is added to `khulnasoft.yaml`.
